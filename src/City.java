...
public class City {
    ...
    public City(int acres, int ateByRates, int bushels, int bushelsHarvested, String name, int newResidents, int residents, int starved, int starvedPercentage, int year) {
        this.acres = acres;
        this.ateByRates = ateByRates;
        this.bushels = bushels;
        this.bushelsHarvested = bushelsHarvested;
    ...
    public TurnResult runTurn() {
        ...
        return new TurnResult(this.name, this.year, this.newResidents, this.bushelsHarvested, this.residents,
                this.bushels, this.starved, this.acres, this.ateByRates, this.starvedPercentage);
    }

    public String showStatus() {
        return (this.acres + " acres of land, " + this.bushels + " bushels of grain, " + this.residents +
                " residents.");
