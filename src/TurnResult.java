...
public class TurnResult{
    ...
    public boolean equals (Object object) {
        ...
        return year == that.year && newResidents == that.newResidents && bushelsHarvested == that.bushelsHarvested && residents == that.residents && bushels == that.bushels && starved == that.starved && acres == that.acres && ateByRates == that.ateByRates && starvedPercentage == that.starvedPercentage && Objects.equals (name, that.name);
    }
    ...
    @Override
    public int hashCode () {
        return Objects.hash (super.hashCode (), name, year, newResidents, bushelsHarvested, residents, bushels, starved, acres, ateByRates, starvedPercentage);
    }

    @Override
    public String toString () {
        return "TurnResult{" + "name='" + name + '\'' + ", year=" + year + ", newResidents=" + newResidents + ", bushelsHarvested=" + bushelsHarvested + ", residents=" + residents + ", bushels=" + bushels + ", starved=" + starved + ", acres=" + acres + ", ateByRates=" + ateByRates + ", starvedPercentage=" + starvedPercentage + '}';
    }
